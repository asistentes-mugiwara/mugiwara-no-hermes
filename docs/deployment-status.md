...
### Configurados parcialmente, pero no desplegados formalmente como agentes activos
También existen perfiles con parte de la base ya preparada, especialmente en la capa de memoria:
...
> ya existe una base operativa real y estable en este mini PC, pero el despliegue completo de toda la tripulación sigue siendo progresivo.
